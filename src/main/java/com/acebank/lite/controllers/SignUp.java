...
public class SignUp extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // Strip spaces added by the frontend formatter (e.g., "1234 5678 9012" →
        // "123456789012")
        if (aadharStr != null)
            aadharStr = aadharStr.replaceAll("\\s+", "");
        ...
        try {
            ...
            User newUser = new User(
                    ...
                    aadharStr,
                    email,
                    null, // phone (not collected in server-side form)
            ...
            if (resultOpt.isPresent()) {
                ...
                response.sendRedirect("sign-up.jsp?error=true");
            }
